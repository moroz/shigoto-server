...
var (
	userAllColumns            = []string{"id", "email", "password_hash", "inserted_at", "updated_at"}
	userColumnsWithoutDefault = []string{"email"}
	userColumnsWithDefault    = []string{"id", "password_hash", "inserted_at", "updated_at"}
