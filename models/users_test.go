...
var (
	userDBTypes = map[string]string{`ID`: `integer`, `Email`: `USER-DEFINED`, `PasswordHash`: `text`, `InsertedAt`: `timestamp without time zone`, `UpdatedAt`: `timestamp without time zone`}
	_           = bytes.MinRead
)
